...
const exercises = [
  {
    ...
    name: 'Bench Press',
    muscleGroup: 'Chest',
    description: 'A compound pressing movement that works the chest (pectorals), front shoulders (anterior deltoids) and triceps',
  ...
  },
  {
    ...
    muscleGroup: 'Chest',
    description: 'A dumbbell variation of the bench press that targets the pectorals, anterior deltoids and triceps',
  ...
  },
  {
    ...
    name: 'Push‑Up',
    muscleGroup: 'Chest',
    description: 'Body‑weight exercise that targets the pectoralis major and minor, triceps and anterior deltoids while engaging the core for stability',
  ...
  },
  {
    ...
    name: 'Bent‑Over Row',
    muscleGroup: 'Back',
    description: 'A pulling exercise that primarily works the latissimus dorsi, trapezius, rhomboids and posterior deltoids',
    equipment: ['barbell'],
    pushPull: 'pull',
    bodyRegion: 'upper',
    environment: ['home', 'gym'],
  ...
  },
  {
    ...
    muscleGroup: 'Back',
    description: 'Variation of the bent‑over row performed one arm at a time; targets the lats, rhomboids and rear shoulders while allowing greater range of motion',
    equipment: ['dumbbell', 'bench'],
    pushPull: 'pull',
    bodyRegion: 'upper',
    environment: ['home', 'gym'],
  ...
  },
  {
    ...
    name: 'Lat Pulldown',
    muscleGroup: 'Back',
    description: 'Machine exercise that targets the back muscles, especially the large latissimus dorsi; grip width can emphasise different parts of the lats, rhomboids and trapezius',
    equipment: ['machine'],
    pushPull: 'pull',
    bodyRegion: 'upper',
    environment: ['gym'],
  ...
  },
  {
    ...
    description: 'Overhead pressing exercise that targets the deltoids, trapezius, serratus anterior and triceps',
  ...
  },
  {
    ...
    name: 'Back Squat',
    muscleGroup: 'Legs',
    description: 'Compound lower‑body exercise that strengthens the quadriceps, hamstrings, glutes and core',
  ...
  },
  {
    ...
    name: 'Deadlift',
    muscleGroup: 'Legs',
    description: 'Hip‑dominant movement that works the trapezius, glutes, hamstrings, core, hip muscles and lats',
    equipment: ['barbell'],
    pushPull: 'pull',
    bodyRegion: 'lower',
    environment: ['home', 'gym'],
  ...
  },
  {
    ...
    muscleGroup: 'Legs',
    description: 'Deadlift variation performed with relatively straight legs to focus on the hamstrings and posterior muscles',
    equipment: ['barbell', 'dumbbell'],
    pushPull: 'pull',
    bodyRegion: 'lower',
    environment: ['home', 'gym'],
  ...
  },
  {
    ...
    name: 'Bicep Curl',
    muscleGroup: 'Arms',
    description: 'Curling a weight toward the shoulders works the biceps brachii primarily and also engages the brachialis and brachioradialis muscles',
